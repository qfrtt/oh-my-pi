...
export type ModelRole = "default" | "smol" | "slow" | "vision" | "plan" | "commit" | "task" | "btw";
...
export const MODEL_ROLES: Record<ModelRole, ModelRoleInfo> = {
	...
	btw: { tag: "BTW", name: "Brainstorm", color: "accent" },
};

export const MODEL_ROLE_IDS: ModelRole[] = ["default", "smol", "slow", "vision", "plan", "commit", "task", "btw"];
